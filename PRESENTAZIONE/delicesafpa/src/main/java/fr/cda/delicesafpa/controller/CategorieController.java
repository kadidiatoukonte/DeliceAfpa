...
public class CategorieController {
	...
	@PostMapping("/addDeterminerCategorie")
	public DeterminerCatDTO addDeterminerCategorie(@RequestBody DeterminerCatDTO determinerCatDTO) {
		return determinerCatService.save(determinerCatDTO);
	}
	
	 @GetMapping(value = "/allDeterminerCategorie")
	 public List<DeterminerCatDTO> getAllDeterminerCategorie(){
		List<DeterminerCatDTO> listDeterminerCatDTO =determinerCatService.getAll();
		return listDeterminerCatDTO;
